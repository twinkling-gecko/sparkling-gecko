...
export class createItemValuesTable1612319140721 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `item_values` (`id` int NOT NULL AUTO_INCREMENT, `value` varchar(255) NOT NULL, `observed_at` timestamp(0) NOT NULL, `created_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, `updated_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, `item_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
